import type { EditorJSDoc } from '~/editorjs';
...
export type Scalars = {
  ...
  EditorJsJSON: { input: EditorJSDoc; output: EditorJSDoc; }
...
export type CreatePrayerCommitmentInput = {
  ...
  readonly organizationSize?: InputMaybe<Scalars['Int']['input']>;
...
export type DonationIntent = {
  ...
  readonly engagement?: InputMaybe<Scalars['String']['input']>;
  /** A GAU ID */
  ...
  readonly program?: InputMaybe<MarketableProgram>;
  /** A CORD Project ID */
