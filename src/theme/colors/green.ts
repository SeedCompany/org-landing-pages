...
export const green = defineSemanticTokens.colors({
  ...
  subtle: {
    bg: {
      DEFAULT: {
        value: { _light: '{colors.green.a3}', _dark: '{colors.green.a3}' },
      },
      hover: {
        value: { _light: '{colors.green.a4}', _dark: '{colors.green.a4}' },
      },
      active: {
        value: { _light: '{colors.green.a5}', _dark: '{colors.green.a5}' },
      },
    },
    fg: {
      DEFAULT: {
        value: { _light: '{colors.green.a11}', _dark: '{colors.green.a11}' },
      },
    },
  },
  surface: {
    bg: {
      DEFAULT: {
        value: { _light: '{colors.green.a2}', _dark: '{colors.green.a2}' },
      },
      active: {
        value: { _light: '{colors.green.a3}', _dark: '{colors.green.a3}' },
      },
    ...
    border: {
      DEFAULT: {
        value: { _light: '{colors.green.a6}', _dark: '{colors.green.a6}' },
      },
      hover: {
        value: { _light: '{colors.green.a7}', _dark: '{colors.green.a7}' },
      },
    },
    fg: {
      DEFAULT: {
