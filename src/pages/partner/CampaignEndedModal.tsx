        ...
        >
          <div>
            {logoUrl && (
              <div className="mx-auto flex items-center justify-center">
                <img src={logoUrl} alt={logoAlt || ''} width="100" height="100" />
              </div>
            )}
          ...
          <div className="mt-5 sm:mt-6">
            <button
              type="button"
              onClick={onClose}
              className="font-lato uppercase inline-flex w-full justify-center rounded-md bg-scTerracotta px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-scTerracottaHover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-scTerracotta"
            >
              Back to site
            </button>
          </div>
